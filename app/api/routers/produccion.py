...
from app.models.schemas import ProduccionCreate, NotificacionResponse
...
def declarar_produccion(payload: ProduccionCreate, auth_ctx: dict = Depends(get_user_context)):
    ...
    Soporta creación automática de rubros nuevos con categorización inteligente.
    """
    ...
    try:
        ...
        return {"mensaje": "Producción declarada exitosamente. Se ha sumado al inventario global.", "data": res.data}
